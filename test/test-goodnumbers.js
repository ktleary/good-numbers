...
const {
  isPrime, generatePrimes, isFibonacci, isGoodNumber, isGreatNumber, luckyNumber, generateGoodNumbers, getRandomFromArr,
...
describe('Prime and Fibonacci Numbers', () => {
  describe('Prime Numbers', () => {
    ...
    it('should generate the sequence 3, 5, 7 ...', () => {
      const primesUnder100 = [3, 5, 7, 11, 13, 17, 19, 23, 29]
  ...
  describe('Test Good Number Generation', () => {
    ...
    it('should return all greatNumbers numbers below 100,000', () => {
      const greatUnder100k = [3, 5, 13, 89, 233, 1597, 28657]
      const options = {
        min: 0,
        max: 100000,
        onlyGreat: true,
